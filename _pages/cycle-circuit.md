      ...
      <!-- TAIL -->
       ...
       <g id="cat-head" transform="translate(4,0)">
        ...
        <g id="cat-item-mouse" transform="translate(2,-2)">
         ...
         <animate id="mouseSqueak" attributeName="opacity" values="1; 1" dur="48s" begin="0s; 1s" repeatCount="indefinite" />
        </g>
        ...
        <g id="cat-item-fish" transform="translate(2,-2)">
         ...
         <!-- Dummy Trigger of Sound -->
         <animate id="boneRattle" attributeName="opacity" values="1; 1" dur="48s" begin="0s; 15s" repeatCount="indefinite" />
       </g>
       ...
       <g id="cat-item-patty">
        ...
        <!-- Dummy Trigger of Sound -->
        <animate id="sizzlePatty" attributeName="opacity" values="1; 1" dur="48s"  begin="0s; 31s" repeatCount="indefinite" />
       </g>
      </g>
     </g>
     <!-- WALKING IN OUT-->

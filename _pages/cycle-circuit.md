...
<g id="tile-3-0" transform="translate(300,0)">
 ...
 <g class="road" data-rotation="0">
  ...
  <animate attributeName="opacity" dur="24s" repeatCount="indefinite" values="0; 1; 1; 0; 0; 1; 1; 0; 0" keyTimes="0; 0.001; 0.0625; 0.0626; 0.124; 0.125; 0.1875; 0.1876; 1"/>
</g>
...
<g id="tile-0-1" transform="translate(0,100)">
 ...
 <g class="road" data-rotation="0">
  ...
  <g id="construction-sign" transform="translate(12,6)">
   <!-- Sign pole -->
  ...
  <g id="excavator" transform="translate(96,5) rotate(90 0 0)">
   ...
   <g id="dust-puffs">
    <!-- Left puff -->
    <circle cx="12" cy="60" r="2" fill="#888" opacity="0">
     <animate attributeName="opacity" values="0;1;0" dur="1.2s" repeatCount="indefinite"/>
     <animate attributeName="r" values="2;4;2" dur="1.2s" repeatCount="indefinite"/>
    </circle>
    <!-- Right puff -->
    <circle cx="18" cy="60" r="2" fill="#888" opacity="0">
    ...
    <!-- Back puff -->
    <circle cx="15" cy="55" r="2" fill="#888" opacity="0">

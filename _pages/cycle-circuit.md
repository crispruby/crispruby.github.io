  ...
  <g id="tile-1-0" transform="translate(100,0)">
   ...
   <g class="road" data-rotation="0">
    ...
    <g id="cat-walk">
     ...
     <animate id="mouseSqueak" attributeName="fill" values="#000; #000" dur="48s" begin="0s; 1s" repeatCount="indefinite" />
     <!-- Dummy Trigger of Sound -->
      <animate id="boneRattle" attributeName="fill" values="#000; #000" dur="48s" begin="0s; 15s" repeatCount="indefinite" />
      <!-- Dummy Trigger of Sound -->
      <animate id="sizzlePatty" attributeName="fill" values="#000; #000" dur="48s"  begin="0s; 31s" repeatCount="indefinite" />
     </g>
     <!-- WALKING IN OUT-->

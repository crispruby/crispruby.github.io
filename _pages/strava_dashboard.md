  ...
  <svg id="tile-world"
    ...
    <g id="tile-1-2" transform="translate(100,200)">
      ...
      <g class="road" data-rotation="0">
        ...
        <!-- Worker figure near valve -->
        <rect x="85" y="24" width="6" height="10" fill="#3366cc" rx="2" /> <!-- body -->
        <line x1="83" y1="26" x2="82" y2="18" stroke="#cc8844" stroke-width="2" /><!-- arms -->
        <line x1="89" y1="26" x2="88" y2="18" stroke="#cc8844" stroke-width="2" />
        <circle cx="87" cy="20" r="4" fill="#f2d6b3" /> <!-- head -->

  ...
  <svg id="tile-world"
    ...
    <g id="tile-2-2" transform="translate(200,200)">
      ...
      <g class="decor-bg">
        ...
        <!-- Top door -->
        <rect x="44" y="22" width="12" height="16" fill="#3a6ff7" rx="2" />
        <circle cx="54" cy="30" r="2" fill="#ffdd33" />
        <!-- Bottom door -->
        <rect x="44" y="62" width="12" height="16" fill="#3a6ff7" rx="2" />
        <circle cx="54" cy="70" r="2" fill="#ffdd33" />
        <!-- Left door -->
        <rect x="12" y="44" width="16" height="12" fill="#3a6ff7" rx="2" />
        <circle cx="24" cy="50" r="2" fill="#ffdd33" />
        <!-- Right door -->
        <rect x="72" y="44" width="16" height="12" fill="#3a6ff7" rx="2" />
        <circle cx="72" cy="50" r="2" fill="#ffdd33" />
      </g>
        <!-- 2. Road (rotates) -->
      <g class="road" data-rotation="0">
        <path d="M 50 0 L 50 100" stroke="#555" stroke-width="28" stroke-linecap="round" />
